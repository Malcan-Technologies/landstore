...
const ReviewStep = ({ formData, updateField }) => {
  return (
    <div className="space-y-5 sm:space-y-6">
      <button
        type="button"
        className="flex min-h-[140px] w-full flex-col items-center justify-center rounded-2xl border border-dashed border-green-secondary/50 bg-[#F4FBF7] px-4 text-center sm:min-h-[160px] sm:px-5 md:min-h-[175px] md:px-6"
      >
        ...
        <p className="mt-2 max-w-[420px] text-[11px] leading-5 text-gray5 sm:text-[12px] md:text-[13px] md:leading-6">
      ...
      <div className="rounded-2xl bg-font2-green px-4 py-4 text-white sm:px-5 sm:py-5">
        <div className="flex items-start gap-2.5 sm:gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-[720px] text-[10px] leading-4 text-white/70 sm:text-[11px] sm:leading-5 md:text-[12px]">
