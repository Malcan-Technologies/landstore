...
const DeleteListingModal = ({ open, onClose, onConfirm, isLoading = false, listingTitle = "" }) => {
  return (
    <Modal
      open={open}
      ...
      closeLabel="Close delete listing modal"
      showCloseButton
    >
      <div className="flex h-full flex-col justify-between">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="mt-5 text-[24px] font-semibold tracking-tight text-gray2">Delete listing</h2>
          <p className="mt-3 max-w-117.5 text-[16px] leading-8 text-gray5">
            {listingTitle
              ? `Are you sure you want to permanently delete \"${listingTitle}\"? This action cannot be undone.`
