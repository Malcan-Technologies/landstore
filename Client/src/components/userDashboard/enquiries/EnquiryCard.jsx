    ...
    >
      <article className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div className="flex flex-1 flex-col gap-4 sm:flex-row md:items-center">
          <div className="relative h-50 sm:w-60 w-full overflow-hidden rounded-lg ">
            <Image
              src={image}
              alt={title}
              fill
          ...
          <div className="min-w-0 flex-1 flex md:flex-row flex-col gap-3 justify-between items-start md:items-center ">
            <div>
              ...
              <h2 className="mt-4 flex items-center gap-2 md:text-[22px] text-lg font-semibold leading-tight text-gray2">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-x-3 gap-y-2 text-[14px] text-gray5">
                ...
                {dealTags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-border-card px-2.5 py-0.5 text-[12px] font-medium text-gray5"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="flex items-center justify-end gap-2 lg:pl-4">
              <span
                className={`inline-flex h-10 w-auto items-center justify-center gap-1.5 rounded-lg px-3 text-[12px] font-semibold transition ${
                  hasUnread
              ...
              <span className="inline-flex h-10 items-center gap-2 rounded-lg bg-[#E3F3EC] px-4 text-[13px] font-medium text-green-secondary transition hover:bg-[#d7ede4]">
                View details
